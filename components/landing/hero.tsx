  ...
  return (
    <section className="flex min-h-screen flex-col items-center justify-center space-y-10 py-24">
      ...
      >
        ...
        >
          Learn Kubernetes by doing. Practical, hands-on challenges designed to help you master container orchestration
          in a local environment. And it's completely free!
        </motion.span>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
