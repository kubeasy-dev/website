...
ou can access your **Kubernetes Journey** in two ways:

- From the `/challenges` page by clicking the **“My Kubernetes Journey”** button
...
At the top of the page, you’ll find a **summary of your journey**:
